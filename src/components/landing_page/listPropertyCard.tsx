	...
	return (
		<section className="px-5 py-8 sm:px-16">
			<div className="flex max-md:flex-col">
				<div className="min-h-[400px] listProperty-bg rounded-t-2xl md:w-1/2 md:rounded-l-2xl"></div>
				<div className="bg-primary-dark-green px-16 text-white flex flex-col justify-center gap-4 rounded-b-2xl max-md:p-8 max-md:items-center md:w-1/2 md:rounded-r-2xl">
